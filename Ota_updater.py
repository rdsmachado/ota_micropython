...
# Classe utilizada para realizar o download e update dos codigos com base no projeto privado do github 
    ...
    # Metodo que verifica se tem atualizacao que ja foi baixada para realizar o update dos codigos
        ...
        try:
            ...
            if 'next' in os.listdir(self.module):
                ...
                # e o diretorio next vira o presente em main_dir, assim eh realizado a atualizacao dos codigos
    ...
    # Metodo que verifica a versao atual do codigo, para isso ele le o numero da versao no arquivo .version na pasta presente em self.main_dir
